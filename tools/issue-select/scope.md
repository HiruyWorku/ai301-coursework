...
I'm most comfortable in Python (data/backend scripting) and have written
some JavaScript. I want to get better at navigating larger, unfamiliar
codebases and reading other people's code. I'd like to avoid pure
frontend/CSS-heavy issues and issues requiring niche domain knowledge
(e.g. compilers, cryptography) I don't have yet.
